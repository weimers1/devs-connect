...
//         <div>
//             <div
//                 className="bg-white md:w-200 md:rounded-xl col-start-1 row-start-1 overflow-hidden shadow-sm border border-gray-100"
//                 id="Billing"
//             >
...
//                 {BILLING_OPTIONS.map((item, index) => (
//                     <div key={item.id}>
//                         <div
...
//                                                 {TRANSACTION_HISTORY.map((transaction, idx) => (
//                                                     <div
//                                                         key={idx}
...
//                         {index !== BILLING_OPTIONS.length - 1 && (
