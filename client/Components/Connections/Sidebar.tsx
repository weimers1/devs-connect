...
function Sidebar() {
    ...
    return (
        <section className="overflow-hidden">
            ...
            <div
                className={`fixed right-0 bottom-0 bg-white rounded-lg shadow-md border border-gray-200 z-2 h-screen overflow-y-scroll transition-all duration-300 ease-in ${
