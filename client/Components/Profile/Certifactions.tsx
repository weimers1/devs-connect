...
//         const [expiryMonth, expiryYear] = cert.dateExpiration
//             ? cert.dateExpiration.split('-')
//             : ['', ''];
...
//                 dateExpiration:
//                     certData.expiryMonth && certData.expiryYear
//                         ? `${certData.expiryMonth}-${certData.expiryYear}`
//                         : '',
...
//             if (editingCert) {
//                 await API.updateCertifications(
//                     editingCert.id.toString(),
//                     certPayload
//                 );
//             } else {
...
//                                     Issued {cert.dateEarned}{' '}
//                                     {cert.dateExpiration &&
//                                         `· Expires ${cert.dateExpiration}`}
//                                 </p>
...
//                                         // Don't update if invalid URL format
//                                         return;
//                                     }
//                                     handleChange('credentialURL', url);
//                                 }}
